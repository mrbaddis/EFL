home_animation = (function() {
	...
	*/
		...
		TweenLite.to(containers, 0.5, {top:-45, scaleX:0.6, scaleY:0.6, left:164});
		//TweenLite.to(pink_heart, 0, {scaleX:0, scaleY:0});
		frame1();
	...
	{
		// Heart Left
		TweenLite.from(leftHeart, 0.3, {left:-308, delay: 0.6, ease: Quad.easeOut});
		// Heart Right
	...
	function frame3()
	{
		...
		TweenLite.to(containers, 0.5, {top:-40, left:85, scaleX:1.15, scaleY:1.15, delay:0.2, opacity:1});
	...
	function frame4()
	{
		...
		TweenLite.to(containers, 0.5, {top:0, left:-2, delay: 0.1, scaleX:1.7, scaleY:1.7, ease: Quad.easeOut});
