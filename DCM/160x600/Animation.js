home_animation = (function() {
	...
	*/
		...
		//TweenLite.to(containers, 0.5, {top:-45, opacity:0 ,scaleX:0.6, scaleY:0.6, left:0});
	...
	function frame1()
	{
		...
		// Heart Right
		TweenLite.from(right_heart, 0.3, {right:-82, delay: 0.6, ease: Quad.easeOut});
	...
	function frame3()
	{
		...
		TweenLite.to(containers, 0.5, {top:-45, opacity:1, scaleX:1, scaleY:1, left:0});
	...
	function frame4()
	{
		...
		TweenLite.to(containers, 0.5, {top:100, delay: 0.1, scaleX:1, scaleY:1, left:0, ease: Quad.easeOut});
