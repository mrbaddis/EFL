home_animation = (function() {
	...
	*/
	...
	function frame1()
	{
		...
		// Heart Right
		TweenLite.from(right_heart, 0.2, {right:-300, delay: 0.6, ease: Quad.easeOut});
		TweenLite.to(leftHeart,0.5, {scaleX:.4, scaleY:.4, delay: 1, opacity:1, top:-5, ease: Quad.easeOut});

		TweenLite.to(right_heart, 0.5,{scaleX:.4, scaleY:.4, delay: 1, opacity:1, top:-5, ease: Quad.easeOut});

		TweenLite.to(pink_heart, 1, {delay: 1.3, opacity:1, ease: Quad.easeOut});
		TweenLite.to(together, 0.6, {opacity:1, delay: 1.9, ease: Quad.easeOut});
	...
	function frame2()
	{
		...
		TweenLite.to(together, 0.5, {opacity:0, ease: Quad.easeOut});
	...
	function frame4()
	{
		...
		TweenLite.to(containers, 1, {top:-3, delay: 0.1, scaleX:1.2, scaleY:1.2, left:-155, ease: Quad.easeOut});
